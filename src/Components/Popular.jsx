...
const Popular = (onClick) => {
  ...
  const logout = () => {
    ...
    useEffect(() => {
      //call API
      // axios.get('http://ec2-15-206-148-202.ap-south-1.compute.amazonaws.com:8001/cityList'
      axios.get(`${API_BASE_URL}/cityList`
      ,
                  ...
                  <div className="right-profile" onClick={dishan}>MT</div>
                  {
                    ...
                    disprofile ?
                      <div className="profile-container">
                        ...
                        <div className="jiv" onClick={logout}>
   ...
   <div className="container-fluid whole">
    <div className="row">
      ...
      <div className="Main">
        <h3 class="city-title" >Select Your City</h3>
      </div>
      </div> */}
    ...
    {/* <div class="whole">
        ...
        <div className="container cities-images">
          <div className="row">
          <div className="pop">
